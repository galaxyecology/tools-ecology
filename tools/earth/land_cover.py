...
##### How to Execute:
# - Load the two images (.TIFF) of the rasters to be processed in the "/data/land_cover/input" folder
...
#from te_algorithms.te_schemas.schemas import BandInfo
#from te_algorithms.util import TEImage
#from te_algorithms.util import teimage_v1_to_teimage_v2

## Methods to manage Rasters

def remap(raster, problem_numbers,alternative_numbers):
    # print("problem_numbers", problem_numbers)
    # print("alternative_numbers", alternative_numbers)
...
#parser.add_argument("--output_tiff", type=pathlib.Path, help="Output tiff")
#parser.add_argument("--contour", type=pathlib.Path, help="Output json")
...
fjson = args.json
#contours_change_yf_yi = args.contour
# Input Rasters
#path_raster_yi = os.getcwd()+'/data/land_cover/input/EU_CLC_1990.tiff'
#path_raster_yf = os.getcwd()+'/data/land_cover/input/EU_CLC_2018.tiff'
...
#fjson = open(os.getcwd()+"/data/land_cover/input/landcover.json")
